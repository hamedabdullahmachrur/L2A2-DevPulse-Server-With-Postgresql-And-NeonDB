...
import { queryMany, queryOne, queryRun } from '../../utils/dbHelper';
...
// ─── Helper: attach reporter data without JOINs ───────────────────────────────
// Fetches reporter info for an array of issues in a single batch query
